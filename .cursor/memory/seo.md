...
## 2026-07-21 06:42 UTC

Яндекс.Вебмастер: API/UI переобход недоступен без OAuth (токена Webmaster нет, Metrika OAuth на проде пустой). Автоматически доступны: IndexNow через proauc_submit_urls_to_indexnow (WP-CLI) и публичный ping https://webmaster.yandex.ru/ping?sitemap=URL (21.07: post-sitemap + sitemap_index → HTTP 200, rs_weight=1). Ручной UI: Индексирование → переобход post-sitemap.xml.

## 2026-07-21 06:53 UTC

21.07: Googlebot robots — убран Disallow: *?*; точечные Disallow фильтров/UTM/sitemap-create (как proauc_catalog_has_noncanonical_query). Источник scripts/robots.txt → scp document root. Live на proauc.ru.

## 2026-07-21 10:21 UTC

Страница /avtodoma/: H1 и SEO title/description без «в наличии» — «Автодома» / «Автодома — кемперы и кабины-кон из Японии и Кореи». Меню уже было «Автодома».

## 2026-07-21 10:38 UTC

21.07 волна 8 блога (4 статьи): avto-iz-yaponii-v-yuzhno-sahalinske, skolko-stoit-privezti-avto-iz-korei, obzor-hyundai-santa-fe-iz-korei, oformlenie-epts-avto-iz-yaponii. seed proauc_blog_seed_v8, JPG covers+Santa Fe in-body, деплой scp, publish 21.07 IDs 3792–3795, IndexNow 5 URL HTTP 200, sitemap-create OK, post-sitemap 27 loc. Commit c99a227.

## 2026-07-21 10:53 UTC

21.07: wave 7 covers — JPG на диске, но meta proauc_blog_thumbnail осталась на bg-alpha/bg-recently SVG (covers_v2 уже прошла). Фикс: covers_v3 + proauc_blog_card_image_url предпочитает images/blog/{slug}.jpg. X-Trail cover+exterior+awd → T33 2023–2025.

## 2026-07-21 11:38 UTC

seov/keywords-by-groups.csv — 508 ключей по группам Smyalichi (Япония/Корея/Китай/спецтехника/мото/гео ДВ/бренды). Источник: monitoring-price fixtures/proauc/semantic-core.csv (импорт в seo.smyalichi.ru). Папка seov/ в .gitignore, не коммитить.

## 2026-07-21 11:43 UTC

seov/keywords-by-groups.csv расширен 2026-07-21: +224 → 732 ключей. Новые группы: Автодома, Грузовики, Компания, ЭПТС, Доставка, Аукцион, Блог, гео Уссурийск/Находка/КНА/ПК/Магадан/Артём/Чита. target_url на реальные пути (/avtodoma/, /spectehnika/gruzoviki/, /oformlenie-epts-…, /dostavka-avto-…). seov/ gitignored.

## 2026-07-21 14:11 UTC

seov/keywords-by-groups.csv 2026-07-22: группа Автодома +99 → 129 ключей (всего CSV 831). Кластеры avtodoma-jp/kr/body/models/geo/info; target /avtodoma/. seov/ gitignored.

## 2026-07-24 04:40 UTC

SEO-анализ proauc.ru — точки роста и исправления.

### Исправлено:
1. **5 future-постов опубликованы** (SQL UPDATE): byd-seal-i-zeekr-001-sravnenie (866), obzor-kia-carnival-iz-korei (865), sravnenie-avto-iz-yaponii-korei-kitaya (872), kak-polzovatsya-statistikoj-aukcionov-yaponii (873), avto-iz-yaponii-v-habarovsk (874). Все HTTP 200.
2. **Schema.org JSON-LD** — главная: Organization + LocalBusiness + WebSite + FAQPage (7 вопросов). Лендинги (/avto-iz-yaponii/, /avto-iz-korei/, /avto-iz-kitaya/, /avtodoma/, /spectehnika/, /motorcycles/): Organization + WebSite + WebPage. Деплой rank-math.php.
3. **Семантическое ядро** — исправлены битые target_url: /avto-iz-kitaya/catalog/geely/ → /avto-iz-kitaya/catalog/geely-auto/, /oformlenie-epts-na-avtomobil/ → /oformlenie-epts-avto-iz-yaponii/.
4. **IndexNow** — 6 URL отправлены (HTTP 200).

### Найдено в анализе:
- 831 ключ, 48 групп, 28→32 поста в блоге
- Nginx proxy_cache (5 min TTL) — X-Cache-Status: MISS → кеш рабочий
- 7 sitemap-файлов: post(32), page(19), korea(294), japan(1295), china(235), lots(784), hdm(281)
- /avto-v-nalichii/ → 301 → /avtodoma/ (корректно)

### Точки роста (не реализовано):
