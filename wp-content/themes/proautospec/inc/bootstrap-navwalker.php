...
class bootstrap_5_wp_nav_menu_walker extends Walker_Nav_menu
{
  ...
  function start_lvl(&$output, $depth = 0, $args = null)
  {
    ...
    $output .= "\n$indent<ul class=\"dropdown-menu$submenu " . esc_attr(implode(" ",$dropdown_menu_class)) . "\">\n";
  }
  ...
  function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
    {
        ...
        $attributes .= ($args->walker->has_children) ? ' class="'. $nav_link_class . $active_class . ' dropdown-toggle" data-bs-hover="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"' . $role : ' class="'. $nav_link_class . $active_class . '"';
