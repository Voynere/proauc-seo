(function (global, factory) {
    ...
    var Pagination = /** @class */ (function () {
        ...
        Pagination.prototype.createPageList = function () {
            ...
            paginationUl.classList.add("pagination-lg");
        ...
        Pagination.prototype.recreatePageElements = function (pageNumber) {
            ...
            var previousPageLi = this.createPageElement("Назад", previousPage);
			//previousPageLi.classList.add("float-start");
            var nextPageLi = this.createPageElement("Вперёд", nextPage);
			//nextPageLi.classList.add("float-end");
        ...
        Pagination.prototype.onPageClick = function (event) {
            ...
            if (this.options.pageClickUrl) {
                if (this.options.pageClickCallback) {
                    this.options.pageClickCallback(pageNumber, event);
                }
                return;
            }
