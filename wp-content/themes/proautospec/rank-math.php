...
function proauc_get_static_landing_seo() {
	return array(
		...
		'/avtodoma/' => array(
			'title'       => 'Автодома в наличии — кемперы и кабины-кон из Японии и Кореи',
			'description' => 'Автодома и кемперы в наличии: кабины-кон, ван-кон и моторхомы из Японии и Кореи. Проверенная история, доставка по России и полное сопровождение сделки.',
		),
		'/avto-v-nalichii/' => array(
			'description' => 'Автодома и кемперы в наличии с проверенной историей и готовностью к покупке! Выгодные условия и полное сопровождение на всех этапах сделки.',
		),
		'/kompaniya/' => array(
