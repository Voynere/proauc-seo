...
get_header();
//$carsApiUrl = (empty($_SERVER['HTTPS']) ? 'http' : 'https') . "://" . $_SERVER['HTTP_HOST'] . "/api/get-hdm-categories.php" ;
...
<div class="container">
	...
	<h1 class="mb-4">Спецтехника из Японии и Кореи под заказ</h1>
...
<?php 
	global $wpdb;
	$hdmGroup = $wpdb->get_row('SELECT * FROM wp_api_hdm_groups WHERE slug = "'. $hdmGroup. '"');
