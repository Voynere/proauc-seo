                ...
                ?>
					...
					<li class="dropdown"><a class="nav-link dropdown-toggle" data-bs-hover="dropdown" aria-haspopup="true" data-bs-auto-close="outside" aria-expanded="false" href="/spectehnika/">Спецтехника</a>
						<ul class="dropdown-menu  depth_0 spectehnika">
							<li><a href="/spectehnika/" class="dropdown-item nav-link--highlighted">Каталог из Японии</a></li>
							<li><a href="/spectehnika/betononasosy/" class="dropdown-item">Бетононасос (швинги)</a></li>
							<li><a href="/spectehnika/avtokrany/" class="dropdown-item">Автокран</a></li>
							<?php
							wp_nav_menu(
								array(
			...
			<div class="row mt-auto">
				...
				<div class="col-lg-7">
					<ul>
						...
						<li><a href="/spectehnika/betononasosy/">Бетононасосы (швинги)</a></li>
						<li><a href="/spectehnika/avtokrany/">Автокраны</a></li>
